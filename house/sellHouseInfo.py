...
from house.addSellHouse import AddInfo
from house.del_SellHouseinfo import DelInfo
from house.searchSellInfo import SearchHouseInfo
...
class SellHouseInfo(object):
    def __init__(self,oldroot):
        ...
        Button(root, text="显示全部信息", command=lambda: rent.show_sellHouse()).place(relx=0.05, rely=0.2, width=80)
